var moment = require('moment').locale('ru');
...
module.exports = function () {
	...
	_helpers.usefullUrl = function (usefullUrl, options) {
		return ('/usefull/category/' + usefullUrl);
	};

	// Direct url link to a specific afisha

/*	_helpers.afishaUrl = function (afishaSlug, options) {
		return ('/afisha/post/' + afishaSlug);
	};

	_helpers.articleUrl = function (articleSlug, options) {
		return ('/article/post/' + articleSlug);
	};
*/
	...
	_helpers.categoryUrlarticle = function (categorySlug, options) {
		return ('/article/' + categorySlug);
	};

	_helpers.boardrubricsUrl = function (board, options) {
		return ('/board/' + board);
	};

	_helpers.subcategoryUrl = function (categorySlug, subCategorySlug, options) {
		return ('/article/' + categorySlug + '/' + subCategorySlug);
	};
	...
	* */
	...
	_helpers.eq = function (lvalue, rvalue, options) {
